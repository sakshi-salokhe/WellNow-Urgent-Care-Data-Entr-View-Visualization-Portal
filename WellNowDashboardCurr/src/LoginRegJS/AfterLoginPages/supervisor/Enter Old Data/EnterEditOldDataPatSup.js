...
class EnterEditOldDataPatSup extends Component
{
	...
	save(event)
	{
		...
		.then(
			res => {
				...
				{
					axios.post('http://localhost:81/WellNow-Urgent-Care-Data-Entr-View-Visualization-Portal/wellnowdash_backend/insert_old_data_patsup.php', qs.stringify(obj))
					.then(res => 
						{
							if(res.data.entered == 1)
							{
...
export default EnterEditOldDataPatSup