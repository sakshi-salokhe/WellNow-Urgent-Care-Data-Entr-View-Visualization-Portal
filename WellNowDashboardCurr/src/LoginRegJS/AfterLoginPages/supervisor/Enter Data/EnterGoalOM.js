...
class EnterGoalOM extends Component
{
	...
	save(event)
	{
		...
		axios.get('http://localhost:81/wellnowdash_backend/check_om_goals.php')
		.then(
			res => {
				...
				if(res.data.ans_val == 1)//data exists already , perform update
				{
					...
					//console.log("obj=",obj);
					axios.post('http://localhost:81/wellnowdash_backend/update_goals_om.php', qs.stringify(obj))
					.then(res => 
						{
							console.log(res.data);
				...
				else //data exists already , perform update
				{
					...
					axios.post('http://localhost:81/wellnowdash_backend/insert_goals_om.php', qs.stringify(obj))
					.then(res => 
						{
							console.log(res.data);
							if(res.data.entered == 1)
