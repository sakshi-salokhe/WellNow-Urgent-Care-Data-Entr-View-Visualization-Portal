...
class EmpList extends Component
{
	...
	edit_user()
	{
		axios.get('http://localhost:81/wellnowdash_backend/get_details_for_editing_sup.php?userid='+this.props.obj.userid+'&supervisor_id='+this.props.obj.supervisor_id)
		.then(
			res => {
