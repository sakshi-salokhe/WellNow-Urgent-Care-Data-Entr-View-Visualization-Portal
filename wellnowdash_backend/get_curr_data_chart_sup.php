...
if($dashboards == '1' or $dashboards == 1)
{
	...
	$sql1 = "select * from ar_goals where when_done = '$curr_mon'";
...
else if($dashboards == '2' or $dashboards == 2)
{
	...
	$sql1 = "select * from os_goals where when_done = '$curr_mon'";
	if($res = mysqli_query($con, $sql))
	{
		$res1 = mysqli_query($con, $sql1);
		$row1 = mysqli_fetch_assoc($res1);
...
else if($dashboards == '3' or $dashboards == 3)
{
	...
	$sql1 = "select * from om_goals where when_done = '$curr_mon'";
	if($res = mysqli_query($con, $sql))
	{
		$res1 = mysqli_query($con, $sql1);
		$row1 = mysqli_fetch_assoc($res1);
...
else if($dashboards == '4' or $dashboards == 4)
{
	...
	$sql1 = "select * from pat_sup_goals where when_done = '$curr_mon'";
	if($res = mysqli_query($con, $sql))
	{
		$res1 = mysqli_query($con, $sql1);
		$row1 = mysqli_fetch_assoc($res1);
